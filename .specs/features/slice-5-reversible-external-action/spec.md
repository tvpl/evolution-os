...
| Validação de assinatura de webhook | HMAC-SHA256 sobre o corpo bruto usando o secret armazenado na conexão, comparação em tempo constante | `integration-contracts.md` §4 exige validar assinatura; a mecânica é real e testável com payloads sintéticos mesmo sem o GitHub real do outro lado | y |
